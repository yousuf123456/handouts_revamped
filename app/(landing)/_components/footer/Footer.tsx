...
import { MessageSquare, PhoneCall, Pointer } from "lucide-react";
    ...
    <footer className="bg-white dark:bg-gray-900">
      <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <div className="flex justify-center text-sky-600 dark:text-sky-300 sm:justify-start"></div>
            ...
            <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
              <li>
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="text-sky-700 transition hover:text-sky-700/75 dark:text-sky-500 dark:hover:text-sky-500/75"
                >
                ...
                <li>
                  ...
                  >
                    ...
                    <span className="relative flex h-2 w-2">
                      ...
                      <span className="size-2 relative inline-flex rounded-full bg-sky-500"></span>
                    </span>
                  </a>
                </li>
              </ul>
        ...
        <div className="mt-12 border-t border-gray-100 pt-6 dark:border-gray-800">
          <div className="text-center sm:flex sm:justify-between sm:text-left">
            <p className="text-sm text-gray-500 dark:text-gray-400">
              ...
              <a
                className="inline-block text-sky-600 underline transition hover:text-sky-600/75 dark:text-sky-500 dark:hover:text-sky-500/75"
                href="#"
              >
                Terms & Conditions
              </a>
